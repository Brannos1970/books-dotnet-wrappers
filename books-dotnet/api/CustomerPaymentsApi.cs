...
namespace zohobooks.api
{
    ...
    public class CustomerPaymentsApi:Api
    {
        ...
        /// </summary>
        /// <param name="parameters">The parameters is the dictionary object which is having the filters to refine the list as key,value pairs.<br></br>The possible filters are described below<br></br>
        /// <table>
        /// <tr>customer_name<td></td><td>Search payments by customer name.<br></br>Variants: <i>customer_name_startswith</i> and <i>customer_name_contains</i></td></tr>
        ...
        /// <tr><td>notes</td><td>Search payments by customer notes.<br></br>Variants: <i>notes_startswith</i> and <i>notes_contains</i></td></tr>
        ...
        /// <tr><td>sort_column</td><td>Sort the payment list.<br></br>Allowed Values: <i>customer_name, unused_amount, amount, bcy_amount, date, reference_number, account_name</i> and <i>payment_mode</i></td></tr>
        /// </table>
        /// </param>
