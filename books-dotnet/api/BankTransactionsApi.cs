...
namespace zohobooks.api
{
    ...
    /// It is used to get:<br></br>The list of all transactions.<br></br>The details of a transaction.<br></br>The matching transactions.<br></br>The list of all associated transactions.<br></br>
    ...
    public class BankTransactionsApi:Api
    {
        ...
        /// </summary>
        /// <param name="parameters">The parameters is used to pass the filters to refine the transactions.
        ...
        /// <table>
        /// <tr><td><b>Filter key</b></td><td>Allowed values</td></tr>
        /// <tr><td>account_id*</td><td>For which transactions are to be listed.</td></tr>
        /// <tr><td>filter_by</td><td><i>Status.All, Status.Uncategorized, Status.Categorized, Status.ManuallyAdded, Status.Excluded</i> and <i> Status.Matched</i></td></tr>
        /// <tr><td>transaction_type</td><td>Transaction type to group the list view</td></tr>
        /// <tr><td>date</td><td><i>date_start </i> and <i>date_end</i></td></tr>
        /// <tr><td>amount</td><td>Start and end amount, to provide a range within which the transaction amount exist Variants:<i>amount_start </i>and <i>amount_end</i></td></tr>
        ...
        /// <tr><td>sort_column</td><td><i>date</i></td></tr>
        /// </table> 
        /// </param>
        ...
        {
            string url = baseAddress + "/" + transaction_id;
        ...
        /// </summary>
        /// <param name="new_transaction_info">The new_transaction_info is the Transaction object which provides the info to create a transaction as a transaction_type parameter is mandatory.</param>
        /// <returns>Transaction object.</returns>
        ...
        /// <param name="update_info">The update_info is the Transaction object which is having the information to update the transaction with transaction_type parameter as mandatory.</param>
        /// <returns>Transaction object.</returns>
        ...
        /// <returns>System.String.<br></br>If the transaction has been deleted it returns the success message.<br></br>The success message is "The transaction has been deleted."</returns>
        ...
        /// <param name="parameters">The parameters is the dictionary object,it contains the match criteria in the form of key value pairs.<br></br>
        /// The parameters contains the below listed possible keys and the corespondent values
        /// <table>
        /// <tr><td>transaction_type</td><td>The type of transaction.<br></br>Allowed Values: <i>expense, deposit, refund, transfer_fund, card_payment, sales_without_invoices, expense_refund, owner_contribution, interest_income, other_income, owner_drawings, invoice, bill, credit_notes, creditnote_refund, customer_payment </i>and <i>vendor_payment</i></td></tr>
        /// <tr><td>date</td><td>Start and end date, to provide a range within which the transaction date exist.<br></br>Variants: date_start and date_end</td></tr>
        /// <tr><td>amount</td><td>Initial and final amount range within which the search amount exists.<br></br>Variants: amount_start and amount_end</td></tr>
        /// <tr><td>contact</td><td>Contact person name, involved in the transaction.</td></tr>
        /// <tr><td>reference_number</td><td>Reference Number of the transaction.</td></tr>
        /// </table>
        /// </param>
        /// <returns>MatchingTransactions object.</returns>
        public MatchingTransactions GetMatchingTransactions(string transaction_id, Dictionary<object, object> parameters)
        {
            string url = baseAddress + "/uncategorized/" + transaction_id + "/match";
            var responce = ZohoHttpClient.get(url, getQueryParameters(parameters));
        ...
        /// <param name="transactions_to_be_matched">The transactions_to_be_matched is the list of transactions objects with transaction_id and transaction_type as mandatory.</param>
        /// <returns>System.String.<br></br>The success message is "The Uncategorized transaction is linked to the selected transaction(s) in Zoho Books."</returns>
        ...
        /// </summary>
        /// <param name="transaction_id">The transaction_id is the identifier of the transaction for which going to be list the associated transactions.</param>
        /// <param name="parameters">The parameters contains sort_coloumn with allowed value <i>statement_date</i> which helps to get associated transactions</param>
        ...
        {
            string url = baseAddress + "/" + transaction_id + "/associated";
            var responce = ZohoHttpClient.get(url, getQueryParameters(parameters));
        ...
        /// <returns>System.String.<br></br>If the transaction has been excluded it returns the success message.<br></br>The success message is "The transaction has been excluded."</returns>
        public string ExcludeATransaction(string transaction_id)
        {
            string url = baseAddress + "/uncategorized/" + transaction_id + "/exclude";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return BankTransactionParser.getMessage(responce);
        }
        /// <summary>
        ...
        /// <returns>System.String object.<br></br>If the transaction has been restored it returns the success message.<br></br>The success message is "The excluded transaction has been restored."</returns>
        public string RestoreATransaction(string transaction_id)
        {
            string url = baseAddress + "/uncategorized/" + transaction_id + "/restore";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return BankTransactionParser.getMessage(responce);
        }
        /// <summary>
        ...
        /// <param name="transaction_info">The transaction_info is the information which requires to create a transaction to catogarise with transaction_type as mandatory parameter.</param>
        ...
        {
            string url = baseAddress + "/uncategorized/" + transaction_id + "/categorize";
        ...
        /// <param name="payment_details">The payment_details is the vendor payment object with vendor_id and amount are the mandatory parameters.</param>
        /// <returns>System.String.<br></br>The success message is "The transaction is now categorized."</returns>
        public string CategorizeAsVendorpayment(string transaction_id, VendorPayment payment_details)
        {
            string url = baseAddress + "/uncategorized/" + transaction_id + "/categorize/vendorpayments";
