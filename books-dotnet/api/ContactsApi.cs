...
namespace zohobooks.api
{
    ...
    public class ContactsApi:Api
    {
        ...
        /// <tr><td>email</td><td>Search contacts by email of the contact person.<br></br>Variants: <i>email_startswith</i> and <i>email_contains</i></td></tr>
        /// <tr><td>phone</td><td>Search contacts by phone number of the contact person.<br></br>Variants: <i>phone_startswith</i> and <i>phone_contains</i></td></tr>
        /// <tr><td>filter_by</td><td>Filter contacts by status.<br></br>Allowed Values: <i>Status.All, Status.Active, Status.Inactive, Status.Duplicate, Status.Customers, Status.Vendors</i> and <i>Status.Crm</i></td></tr>
        /// <tr><td>search_text</td><td>Search contacts by contact name or notes.</td></tr>
        ...
        public string SendEmailContact(string contact_id, EmailNotification email_content, Dictionary<object, object> parameters, string[] attachment_paths)
        {
...
//--------------------------------------------------------------------------------------------
        ...
        /// </summary>
        /// <param name="contact_person_id">The contact_person_id is the identifier of the contact person.</param>
        /// <param name="update_info">The update_info is the ContactPerson object with contact_id as mandatory parameter which contains the changes to be modified.</param>
        /// <returns>ContactPerson object.</returns>
        ...
        /// </summary>
        /// <param name="contact_person_id">The contact_person_id is the identifier of the contact person.</param>
        /// <returns>System.String.<br></br>The success message is "This contact person has been marked as your primary contact person."</returns>
