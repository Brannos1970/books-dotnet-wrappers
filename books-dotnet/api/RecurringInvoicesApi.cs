...
namespace zohobooks.api
{
    ...
    public class RecurringInvoicesApi:Api
    {
        ...
        /// <table>
        /// <tr><td>recurrence_name</td><td>Search recurring invoices by name.<br></br>Variants: <i>recurrence_name_startswith</i> and <i>recurrence_name_contains</i></td></tr>
        /// <tr><td>item_name</td><td>Search recurring invoices by item name.<br></br>Variants: <i>item_name_startswith</i> and <i>profileitemname_contains</i></td></tr>
        /// <tr><td>item_description</td><td>Search recurring invoices by item description.<br></br>Variants: <i>item_description_startswith</i> and <i>item_description_contains</i></td></tr>
        /// <tr><td>customer_name</td><td>Search recurring invoices by customer name.<br></br>Variants: <i>customer_name_startswith</i> and <i>customer_name_contains</i></td></tr>
        ...
        /// <tr><td>notes</td><td>Search recurring invoices by notes.<br></br>Variants: <i>notes_startswith</i> and <i>notes_contains</i></td></tr>
        /// <tr><td>start_date</td>Search recurring invoices by start date.<br></br>Variants: <i>start_date_start, start_date_end, start_date_before</i> and <i>start_date_after</i><td></td></tr>
        /// <tr><td>end_date</td><td>Search recurring invoices by end date.<br></br>Variants: <i>end_date_start, end_date_end, end_date_before</i> and <i>end_date_after</i></td></tr>
        /// <tr><td>customer_id</td><td>Search recurring invoices by customer id.</td></tr>
        /// <tr><td>status</td><td>Search recurring invoices by status.<br></br>Allowed Values: <i>active, stopped</i> and <i>expired</i></td></tr>
        /// <tr><td>filter_by</td><td>Filter recurring invoices by any status.<br></br>Allowed Values: <i>Status.All, Status.Active, Status.Stopped</i> and <i>Status.Expired</i></td></tr>
        /// <tr><td>search_text</td><td>Search recurring invoices by recurring invoice name or customer name.</td></tr>
        /// <tr><td>sort_column</td><td>Sort recurring invoices.<br></br>Allowed Values: <i>customer_name, recurrence_name, total, start_date, end_date, last_sent_date, next_invoice_date</i> and <i>created_time</i></td></tr>
        /// </table>
        /// </param>
        ...
        {
            string url = baseAddress + "/" + recurring_invoice_id + "/status/resume";
            var responce = ZohoHttpClient.post(url, getQueryParameters());
            return RecurringInvoiceParser.getMessage(responce);
        }
        ...
        {
            string url = baseAddress + "/" + recurring_invoice_id + "/comments";
            var responce = ZohoHttpClient.get(url, getQueryParameters());
